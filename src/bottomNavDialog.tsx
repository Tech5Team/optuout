...
const privacystatement = (
    <div>
<Typography variant="h6">I. INTRODUCTION:</Typography>
...
<Typography variant="h6">II. PERSONAL INFORMATION:</Typography>
<Typography variant="body1">
...
<Typography variant="h6">III. USE OF & DISCLOSURE OF PERSONAL INFORMATION:</Typography>
<Typography variant="body1">
...
<Typography variant="h6">IV. COOKIES & TRACKING TECHNOLOGIES:</Typography>
<Typography variant="body1">
...
<Typography variant="h6">V. USER RIGHTS:</Typography>
<Typography variant="body1">
...
sent to the tech5 contact email, tech5team@proton.me.
</Typography>
<Typography variant="h6">VI. CHANGES TO PRIVACY STATEMENT:</Typography>
<Typography variant="body1">
...
<Typography variant="h6">VII. CONTACT INFORMATION:</Typography>
<Typography variant="body1">
Any questions or concerns regarding Opt-U-Out, or our privacy statement can be
sent to tech5team@proton.me. We are committed to reviewing and responding to
  ...
  return (
    ...
    >
      ...
      <DialogContent>
       ...
       <Typography> {contact? "tech5team@proton.me"  : privacystatement} </Typography>      
</DialogContentText>
      </DialogContent>
      <DialogActions>
